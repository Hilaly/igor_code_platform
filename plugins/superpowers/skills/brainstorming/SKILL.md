---
name: brainstorming
description: Use when starting creative work such as features, components, new functionality, or behavior changes, before implementation
---
...
You MUST reflect this checklist in a per-session Mission through `mission-update`, keep its statuses
...
9. **Transition to implementation** — invoke `superpowers.writing-plans` to create implementation plan
...
digraph brainstorming {
    ...
    "User reviews spec?" -> "Invoke superpowers.writing-plans" [label="approved"];
}
```
