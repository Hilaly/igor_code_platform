...
В `icons.tsx` поэлементно импортировать `Copy`, `GitBranchPlus`, `GitFork`, `Tag`, `TagX` и
...
- [x] **Шаг 1: заменить тест меню метки тестом единого ряда icon-only действий**
...
- [x] **Шаг 2: добавить падающие тесты времени, ролей и ограничений**
...
- [x] **Шаг 3: подтвердить RED старой разметки**
...
- [x] **Шаг 4: реализовать строку времени и действий**
...
- [x] **Шаг 5: подтвердить GREEN структуры и прежнего поведения**
...
- [x] **Шаг 6: сделать промежуточный коммит панели**
...
- [x] **Шаг 1: добавить падающий тест состава копируемого текста**
...
- [x] **Шаг 2: добавить падающие тесты отсутствующего текста и ошибки clipboard**
...
- [x] **Шаг 3: подтвердить RED неработающего копирования**
...
- [x] **Шаг 4: реализовать сбор текста и обратную связь**
...
- [x] **Шаг 5: подтвердить GREEN компонента и интеграции**
...
- [x] **Шаг 6: сделать атомарный коммит копирования**
...
- [x] **Шаг 1: запустить полный автоматический gate**
...
- [x] **Шаг 2: проверить production-сборку**
...
- [x] **Шаг 3: проверить экран в настоящем браузере**
...
Проверено 5 августа 2026 года временным browser-fixture на настоящем `SessionMessageList`, потому
что отдельный worktree не содержал готовой сессии демона. Fixture и снимки не добавлены в git.
Проверены четыре поставляемые схемы, обычное/hover/focus-состояния, обе стороны реплики, узкая лента
360 px, русские и английские крайние tooltip. Границы tooltip остались внутри scroll-контейнера;
ошибок и предупреждений консоли не было.

- [x] **Шаг 4: закрыть документацию и план**
...
- [x] **Шаг 5: повторить проверки после любых правок визуального QA**
...
- [x] **Шаг 6: сделать финальный документационный коммит, если остались изменения**
