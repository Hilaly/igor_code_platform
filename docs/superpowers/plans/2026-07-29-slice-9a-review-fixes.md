...
- [ ] Add an HTTP regression test that issues concurrent overridden prompts and observes one 202
      response and one busy refusal; add a summary override regression test.
