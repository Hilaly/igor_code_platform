...
- [roadmap.md](roadmap.md) — какими срезами собирается платформа: пройденные 1–15 и утверждённый
  срез 16 до продакшн-артефакта.
...
- [subagents.md](subagents.md) — встроенный плагин `subagents`: как агент поручает кусок работы
  подчинённой скрытой сессии, набор инструментов, жизненный цикл и правила уведомления родителя.
