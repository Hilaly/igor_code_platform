...
- Исходников встроенных плагинов внутри артефакта: собранный артефакт отдаёт фронтенд из памяти, но
  корень встроенных плагинов по-прежнему считается от исходников репозитория, поэтому в продакшне их
  не видно ([toolchain.md](toolchain.md), [roadmap.md](roadmap.md), срез 16b).
