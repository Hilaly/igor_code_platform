...
временного плагина в директории данных. Заведено в срезе 9b, переиспользовано в 10a; рецепт лежит
здесь, потому что дважды собирать его заново дороже, чем записать.
