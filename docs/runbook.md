...
- Продакшн-сборки единым приложением: не решено, как фронтенд попадает в неё и кто ставит
  зависимости плагинов. `make build` пока собирает только веб-интерфейс.
