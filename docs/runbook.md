...
каждую правку его исходников. Что происходит — видно в журнале демона и в потоке событий: переходы
жизненного цикла идут записями `plugin lifecycle`, строки самого плагина — с источником
`plugin:<id>`. Набор применённых вкладов пишется на уровне `debug`:
...
- Из плагинной системы нет типизированных видов вкладов, доступа к шине, HTTP-маршрутов плагина, его
