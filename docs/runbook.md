...
- Продакшн-сборки единым приложением: решено, что в артефакт вшиты статика фронтенда и исходники
  ...
  веб-интерфейс.
- Из плагинной системы нет большинства типизированных видов вкладов (есть событие, агент, инструмент и
  подписка на хук), HTTP-маршрутов плагина, его хранилища и браузерной части — перечень в
