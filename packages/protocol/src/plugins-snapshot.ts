...
export type PluginsSnapshot = {
   ...
   *
   * Действующий — но не в одном контексте: разрешение контекстное (docs/plugins.md), а снимок один
   * на всё окно, поэтому здесь объединение результатов базового контекста и каждого проектного.
