 ...
 *
 * Вся текущая поверхность этого entrypoint стабильна: и токены, и примитивы меняются по общему
 * правилу публичного контракта (docs/public-contract.md, docs/ui-kit.md).
 *
