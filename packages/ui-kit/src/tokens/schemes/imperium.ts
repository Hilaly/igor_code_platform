/**
 * Схема «imperium», перенесённая из кита предыдущего захода на проект (docs/roadmap.md, срез 5).
 * Пурпур и золото на тёплой бумаге: единственная тема со вторым акцентом в деле.
 *
