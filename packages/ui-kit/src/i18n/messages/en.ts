...
export const coreEnglish: CatalogRegistration = {
  ...
  messages: {
    ...
    "chat.stats.title": "Session statistics",
    "chat.context.title": "Context",
    "chat.context.window.title": "Context window",
    "chat.context.share": "{used}% used · {left}% left",
    "chat.context.tokens-used": "{used} / {window} tokens",
    ...
    "chat.stats.cost.unavailable": "Cost: —",
    ...
    "chat.slash.label": "Session commands",
    "chat.slash.open": "Command",
    "chat.slash.hidden": "by hand only",
    "chat.slash.compact": "Fold the context; what to keep goes after the name",
    "chat.slash.fork": "Fork the session and open the copy",
    "chat.slash.rename": "Name the session; the new name goes after the command",
    "chat.slash.archive": "Move the session to the archive",
    "chat.slash.images": "A command is sent without the attached images",
    ...
    "chat.attachment.unsupported": "The file {file} is not an image of a supported type",
    "chat.attachment.unreadable": "The file {file} could not be read",
    "chat.image.alt": "Image {index} of {total}",
    "chat.image.open": "Open image {index} of {total}",
    "chat.image.counter": "{index} of {total}",
    "chat.image.previous": "Previous",
    "chat.image.next": "Next",
    "chat.image.download": "Download the original",
    "chat.queued.images": "Images: {count}",
    "chat.queue.waiting": "Waiting its turn",
    "chat.queue.steer": "Steer into the running turn",
    "chat.queue.drop": "Take off the queue",
    "chat.queue.stopped": "The queue stopped: {reason}",
    ...
    "page.plugin.back": "Go to the shell",
    "page.plugin.waiting": "The plugin is getting ready",
    "page.plugin.switchedOff": "This page is switched off",
    "page.plugin.switchedOff.hint": "Switch the plugin of {address} back on and the page returns.",
    "page.plugin.failed": "The plugin of this page did not start",
    "page.plugin.missing": "No such page",
    "page.plugin.missing.hint": "No plugin declares the page {address}.",
    ...
    "command.session.archive": "Open the archive",
    "command.settings.projects": "Settings: projects",
    ...
    "command.panel.left.show": "Show the navigation panel",
    ...
    "commands.group.session": "Sessions",
    "commands.group.settings": "Settings",
    "commands.group.panels": "Panels",
    "commands.group.plugins": "Plugins",
    "commands.title": "Commands",
    "commands.open": "Commands",
    "commands.filter": "Find a command",
    "commands.empty": "No command goes by that name",
    "plugins.kind.agent": "Agents",
    "plugins.kind.color-scheme": "Colour schemes",
    "plugins.kind.command": "Commands",
    "plugins.kind.page": "Pages",
    "plugins.pages.title": "Pages",
    "plugins.pages.open": "Open",
    "plugins.kind.component": "Components",
    "plugins.kind.custom": "Other contributions",
    "plugins.kind.event": "Events",
    "plugins.kind.hook": "Subscriptions",
    "plugins.kind.locale-catalog": "Message catalogues",
    "plugins.kind.place": "Places",
    "plugins.kind.public-route": "Public routes",
    "plugins.kind.route": "Routes",
    "plugins.kind.skill": "Skills",
    "plugins.kind.tool": "Tools",
    "plugins.parameters": "Argument schema",
    "plugins.places.title": "Occupied places",
    "plugins.places.switchedOff": "switched off",
    "plugins.places.taken": "provides the place",
    "plugins.places.free": "the place is free: the contribution is switched off",
    ...
    "settings.appearance.preview.label": "Preview: {scheme}, {variant}, {scale}",
    "settings.appearance.preview.surface": "Surface",
    "settings.appearance.preview.accent": "Accent",
    "settings.appearance.preview.secondary": "Secondary",
    "settings.appearance.preview.text": "Text",
    ...
    "usage.failure.title": "Usage could not be loaded",
    "usage.empty": "No usage recorded yet",
    "usage.partial": "Statistics loaded for {loaded} of {listed} sessions",
    "usage.partial.catalog": "Some exact usage is unavailable",
    "usage.unavailable": "No exact statistics are available",
    "usage.totals": "Exact totals",
    "usage.metric.sessions": "Sessions with statistics",
    "usage.metric.messages": "Messages",
    "usage.metric.tokens": "Tokens",
    "usage.metric.cached": "Cached tokens",
    "usage.metric.uncached": "Uncached tokens",
    "usage.metric.cost": "Cost",
    "usage.chart.title": "Tokens by session",
    "usage.table.title": "Exact usage by session",
    "usage.column.session": "Session",
