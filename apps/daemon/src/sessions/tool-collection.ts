...
export type ToolContext = {
  ...
  folder: string;
  /**
   * Сессия, для которой собирается набор. Инструменту она нужна, чтобы связать сделанное с тем, кто
   * его позвал, — иначе плагин узнаёт только аргументы вызова и не имеет обратного адреса
   * (docs/plugins.md).
   */
  sessionId: string;
};
